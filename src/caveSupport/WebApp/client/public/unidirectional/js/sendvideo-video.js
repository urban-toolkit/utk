...
export class SendVideo {
  ...
  // async startVideo(localVideo, videoSource, audioSource, videoWidth, videoHeight) {
    try {
      ...
      // this.localStream = this.localCanvas.captureStream(60); // added
  ...
  addTracks(connectionId) {
    ...
    // const tracks = _this.localStream.getTracks(); // added
    // const tracks = _this.localVideo.captureStream().getVideoTracks();
