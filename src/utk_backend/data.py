...
def shadow_utk_binary(layerJSONs, intervals):

    coordinates = []
    utk_loader = UTK_Binary_Loader()

    ### FIGURE OUT WHAT SURFACE DOES
    for layerJSON in layerJSONs:
    ...
    shadowAccumulator = ShadowAccumulator(centroid[1], centroid[0], layerJSONs, intervals)
    shadowAccumulator.accumulate_shadow()
