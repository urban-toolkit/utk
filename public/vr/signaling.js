...
export class Signaling extends EventTarget {
  ...
  url(method, parameter='') {
    // let ret = location.origin + '/signaling'; //location.origin should return the address of the signaling server but in this solution it is running on a different port
    let ret = "http://localhost" + '/signaling'; // hard coded localhost
...
export class WebSocketSignaling extends EventTarget {
  ...
  constructor() {
    ...
    if (location.protocol === "https:") {
      ...
      // websocketUrl = "ws://" + location.host; // should be the address of the signaling server
      websocketUrl = "ws://" + "localhost"; // should be the address of the signaling server
    }
